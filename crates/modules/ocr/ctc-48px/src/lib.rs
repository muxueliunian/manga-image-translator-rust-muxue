            ...
            for (i, single_line) in texts.into_iter().enumerate() {
                ...
                for (chid, logprob, fr, fg, fb, br, bg, bb) in single_line {
                    ...
                    if ch == "<SP>" {
                        ...
                        avgs[0].update((fr * 255.0) as u8);
                        avgs[1].update((fg * 255.0) as u8);
                        avgs[2].update((fb * 255.0) as u8);
                        avgs[3].update((br * 255.0) as u8);
                        avgs[4].update((bg * 255.0) as u8);
                        avgs[5].update((bb * 255.0) as u8);
                    }
